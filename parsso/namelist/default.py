...
__all__ = ['all_names', 'all_namelists']

TYPED_CONTROL_NAMELIST = OrderedDict([
    ('calculation', str),
    ('title', str),
    ('verbosity', str),
    ('restart_mode', str),
...
TYPED_SYSTEM_NAMELIST = OrderedDict([
    ('ibrav', int),
    ('celldm', List[float]),
    ('A', float),
    ('B', float),
...
TYPED_ELECTRONS_NAMELIST = OrderedDict([
...
TYPED_IONS_NAMELIST = OrderedDict([
    ('ion_dynamics', str),
    ('ion_positions', str),
...
TYPED_CELL_NAMELIST = OrderedDict([
    ('cell_dynamics', str),
    ('press', float),
    ('wmass', float),
    ('cell_factor', float),
...
TYPED_INPUTPH_NAMELIST = OrderedDict([
    ('amass', int),
    ('outdir', str),
    ('prefix', str),
    ('niter_ph', int),
...
def all_namelists():
    return {
        'CONTROL': TYPED_CONTROL_NAMELIST,
        'SYSTEM': TYPED_SYSTEM_NAMELIST,
        'ELECTRONS': TYPED_ELECTRONS_NAMELIST,
        'IONS': TYPED_IONS_NAMELIST,
        'CELL': TYPED_CELL_NAMELIST,
        'INPUTPH': TYPED_INPUTPH_NAMELIST
    }


def all_names():
    _ = defaultdict(set)
    for v in {'CONTROL', 'SYSTEM', 'ELECTRONS', 'IONS', 'CELL', 'INPUTPH'}:
        for k in eval('TYPED_{0}_NAMELIST'.format(v)):
            _[k].add(v)
